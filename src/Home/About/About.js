    ...
    <div className="hero my-20 ">
      <div className="hero-content flex-col lg:flex-row w-full">
        ...
        <div className="w-1/2">
          ...
          <p className="py-6">
            This is old mobile collection site. Here you can select various type
            of phone in very low cost. If you want to sell item you can easily
            do it by register as a seller. This site is very much user friendly.
          </p>
        </div>
      </div>
    </div>
